...
namespace JuniorBoardIT.UnitTests.CQRS.CommandHandlers.Bugs.BugsNotes
{
    [TestFixture]
    public class TestSaveBugNoteCommandHandler
    {
        ...
        public void SetUp()
        {
            ...
            context.Setup(x => x.CreateOrUpdate(It.IsAny<Core.Entities.Bugs>())).Callback<Core.Entities.Bugs>(bug => bugs[0] = bug);
            context.Setup(x => x.CreateOrUpdate(It.IsAny<Core.Entities.BugsNotes>())).Callback<Core.Entities.BugsNotes>(bugNote => bugsNotes.Add(bugNote));
