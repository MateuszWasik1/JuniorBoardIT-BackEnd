...
namespace JuniorBoardIT.UnitTests.CQRS.QueryHandler.Roles
{
    ...
    public class TestGetIsUserAdminQueryHandler
    {
        ...
        [Test]
        public void TestGetIsUserAdminQueryHandler_UserNotFound_ShouldReturn_False()
        {
            //Arrange
        ...
        [Test]
        public void TestGetIsUserAdminQueryHandler_UserIsUser_ShouldReturn_False()
        {
            //Arrange
        ...
        [Test]
        public void TestGetIsUserAdminQueryHandler_UserIsPremium_ShouldReturn_False()
        {
            //Arrange
        ...
        [Test]
        public void TestGetIsUserAdminQueryHandler_UserIsRecruiter_ShouldReturn_False()
        {
            //Arrange
        ...
        [Test]
        public void TestGetIsUserAdminQueryHandler_UserIsSupport_ShouldReturn_False()
        {
            //Arrange
        ...
        [Test]
        public void TestGetIsUserAdminQueryHandler_UserIsAdmin_ShouldReturn_True()
        {
            //Arrange
