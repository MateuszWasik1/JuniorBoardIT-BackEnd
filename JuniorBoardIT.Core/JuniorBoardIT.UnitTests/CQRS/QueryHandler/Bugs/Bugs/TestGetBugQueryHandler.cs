...
namespace JuniorBoardIT.UnitTests.CQRS.QueryHandler.Bugs.Bugs
{
    [TestFixture]
    public class TestGetBugQueryHandler
    {
        ...
        public List<Core.Entities.Bugs> allBugs;
        ...
        public void SetUp()
        {
            ...
            allBugs = new List<Core.Entities.Bugs>
            {
                new Core.Entities.Bugs()
                {
                    BID = 2,
            ...
            mapper.Setup(m => m.Map<Core.Entities.Bugs, BugViewModel>(It.IsAny<Core.Entities.Bugs>())).
                Returns((Core.Entities.Bugs bug) => 
                    new BugViewModel()
                    {
                        BGID = bug.BGID,
                        BTitle = bug.BTitle,
