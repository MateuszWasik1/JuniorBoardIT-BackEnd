...
namespace JuniorBoardIT.UnitTests.CQRS.QueryHandler.Bugs.BugsNotes
{
    [TestFixture]
    public class TestGetBugNotesQueryHandler
    {
        ...
        public List<Core.Entities.Bugs> bugs;
        public List<Core.Entities.BugsNotes> bugsNotes;
        public List<Core.Entities.BugsNotes> allBugsNotes;
        ...
        public void SetUp()
        {
            ...
            bugs = new List<Core.Entities.Bugs>()
            {
                new Core.Entities.Bugs()
                {
                    BID = 1,
            ...
            bugsNotes = new List<Core.Entities.BugsNotes>()
            {
                new Core.Entities.BugsNotes()
                {
                    BNID = 1,
            ...
            allBugsNotes = new List<Core.Entities.BugsNotes>
            {
                bugsNotes[0],
                bugsNotes[1],
                bugsNotes[2],
            ...
            context.Setup(x => x.CreateOrUpdate(It.IsAny<Core.Entities.Bugs>())).Callback<Core.Entities.Bugs>(bug => bugs.Add(bug));

            user.Setup(x => x.UID).Returns(1);

            mapper.Setup(m => m.Map<Core.Entities.BugsNotes, BugsNotesViewModel>(It.IsAny<Core.Entities.BugsNotes>())).
                Callback((Core.Entities.BugsNotes bugNote) =>
